...
def main() -> None:
    ...
    require(styles_css, ".candidate-results-table", "candidate table CSS")
    require(styles_css, ".candidate-score-table-pill", "score pill CSS")
    require(styles_css, "nth-child(even)", "zebra row CSS")
