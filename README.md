...
- Current active phase: Phase 8.5 `Agentic Candidate Review & Iteration`.
...
- candidate-workspace implementation is completed through `P8-007` / `P8-007B`, chat-quality hardening is completed through `P8-016` plus P8-032 slices, and Phase 8.5 has completed `P8.5-001` as contract-first agentic candidate review rather than changing persistence or backend search behavior implicitly;
- Phase 8.5 is the active reviewed direction after the Phase 7.5 closeout decision `ready after approved fixes completed` and the P8-032 parent closeout;
