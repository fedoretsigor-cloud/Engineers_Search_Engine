...
- Phase 8.8 completed the bounded recruiter-facing conversation hardening slice before persistence, including LLM-first role/field/pending-action intent hardening while backend validation remains authoritative;
