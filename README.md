...
- candidate-workspace implementation is completed through `P8-007` / `P8-007B` and chat-quality hardening is completed through `P8-015`; next Phase 8 work should continue from reviewed backlog tasks rather than changing persistence or backend search behavior implicitly;
