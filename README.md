...
- Current active phase: Phase 5.5 `Technical modularization before Agent Runtime`, completed through `P5.5-007`.
...
- next Phase 5.5 task to review: `P5.5-008 Split FastAPI routes from domain logic`;
