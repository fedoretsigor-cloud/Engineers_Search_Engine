...
- candidate-workspace implementation is completed through `P8-007` / `P8-007B`, chat-quality hardening is completed through `P8-016` plus P8-032 slices, and Phase 8.5 has completed `P8.5-001`/`P8.5-002`/`P8.5-003` as contract-first deterministic agentic candidate review rather than changing persistence or backend search behavior implicitly;
