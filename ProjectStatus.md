...
Phase 8.8 is added as a recruiter-facing concern backlog before persistence. Current draft backlog items are `P8.8-001 Add bounded LLM role-domain classifier before Search Brief extraction`, `P8.8-002 Add bounded LLM pending-action intent classifier`, `P8.8-003 Route ambiguous recruiter replies through LLM-first intent layer`, `P8.8-004 Add evidence gate against hallucinated Search Brief readiness`, `P8.8-005 Add bounded small-talk intent and wording consistency`, `P8.8-006 Add bounded LLM conversational wording layer`, and `P8.8-007 Hide technical search preparation panels from recruiter UI`. They are draft/not approved/not implemented. The direction is to make bounded LLM intent recognition the main conversation intelligence layer while keeping deterministic hard safety guardrails and backend/runtime validation as the authority layer.
...
- Phase 8.8: `Recruiter Concern Backlog before Persistence`, added as draft backlog for newly observed recruiter-facing concerns; no tasks are approved or implemented yet.
...
- Phase 8.8: `Recruiter Concern Backlog before Persistence`; `P8.8-001`, `P8.8-002`, `P8.8-003`, `P8.8-004`, `P8.8-005`, `P8.8-006`, and `P8.8-007` are draft/not approved/not implemented.
