...
- Phase 8.5 is now the active reviewed direction; `P8.5-001 Define agentic candidate review contract`, `P8.5-002 Add top-candidate recommendation from returned workspace facts`, `P8.5-003 Add selected-candidate comparison`, and `P8.5-004 Add fit/gap explanation across selected candidates` are completed;
