...
- Phase 7 is now the active direction, `P7-001 Define agent message taxonomy and lifecycle mapping` is implemented as the docs-only `Agent Message Taxonomy V0` contract, and `P7-002 Define message facts and source-of-truth contract` is implemented as the docs-only `Agent Message Facts Contract V0`;
- next Phase 7 task to review is `P7-003 Define agent wording style and language policy`;
