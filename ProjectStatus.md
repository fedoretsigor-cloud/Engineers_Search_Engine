...
- Phase 8.5 is now the active reviewed direction; `P8.5-001 Define agentic candidate review contract` and `P8.5-002 Add top-candidate recommendation from returned workspace facts` are completed;
