...
- [ ] P1-001 Определить границы POC
- [ ] P1-002 Выбрать минимальный стек
- [ ] P1-003 Зафиксировать тестовый сценарий POC
- [ ] P1-004 Создать каркас проекта
- [ ] P1-005 Собрать X-ray Boolean-запрос из формы
- [ ] P1-006 Подключить поиск через Tavily
- [ ] P1-007 Показать raw результаты Tavily во фронте
- [ ] P1-008 Нормализовать результаты поиска
- [ ] P1-009 Добавить базовую оценку релевантности
- [ ] P1-010 Описать выводы POC
...
- Стек через запятую преобразуется в условия запроса.
