...
- Phase 9.9: `AI Agent Semantic Understanding Hardening` in progress through `P9.9-006`. Includes bounded clean-state Search Brief extraction, strict validator, clean-state integration, legacy semantic-branch retirement, automated semantic recruiter UAT, bounded refinement interpreter v2, and closeout.
