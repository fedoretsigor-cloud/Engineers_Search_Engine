...
- Phase 8: `Candidate Workspace/Table + Shortlist`; current active phase after `P7.5-010`. `P8-001 Define candidate workspace contract`, `P8-002 Build recruiter-facing candidate table`, `P8-003 Add sorting and filtering by quality signals`, `P8-004 Add shortlist, notes, and statuses`, `P8-005 Add candidate-level agent explanations`, `P8-006.1 Implement explicit selected-candidate wording overlay`, `P8-007 Prepare export workflow`, and `P8-008` through `P8-015` are completed. The current implementation is frontend-only workspace/table, sorting/filtering, browser in-memory review state, deterministic candidate explanations, bounded explicit selected-candidate wording overlay, local export UI/download workflow, and bounded recruiter-chat quality hardening.
