...
- Phase 6: `Tool-Calling Agent Runtime`; next task to review is `P6-001 Define human-approved Agent Runtime contract`.
...
- Next planned task is `P6-001 Define human-approved Agent Runtime contract`.
