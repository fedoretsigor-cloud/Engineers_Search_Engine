...
def recruiter_chat_refusal_source_message(language: str) -> str:
    if language == "ru":
        return (
            ...
            "\u041c\u043e\u0433\u0443 \u043f\u043e\u043c\u043e\u0447\u044c "
            "\u0441\u0444\u043e\u0440\u043c\u0438\u0440\u043e\u0432\u0430\u0442\u044c "
            "Search Brief \u0434\u043b\u044f approved backend pipeline."
        )
...
def brief_refinement_source_message(
    ...
    if language == "ru":
        return (
            f"\u041e\u0431\u043d\u043e\u0432\u0438\u043b Search Brief ({action_summary}). "
            "\u041d\u0443\u0436\u043d\u043e \u0437\u0430\u043d\u043e\u0432\u043e "
            "\u043f\u043e\u0441\u0442\u0440\u043e\u0438\u0442\u044c \u043f\u043b\u0430\u043d."
        )
...
def agent_plan_action_error_source_message(error_code: str) -> str:
    messages = {
        ...
        AGENT_PLAN_ERROR_UNSUPPORTED_ACTION: "Build Plan proposed_action is not supported.",
    ...
    return messages.get(error_code, "Agent Plan action is not supported.")


def query_plan_ready_approval_notice() -> str:
    return "Search plan is ready. Review the queries before running search."


def query_plan_fallback_approval_notice() -> str:
    return "Fallback search plan is ready. Review the queries before running search."


def query_plan_rejected_approval_notice() -> str:
    return "A fallback plan is available but not executed. Search execution requires approval."


def query_plan_ai_validated_approval_notice() -> str:
    return "This AI plan is validated but not executed yet. Search execution requires approval."


def query_plan_preview_approval_notice() -> str:
    return "This plan is not executed yet. Search execution requires approval."
...
def runtime_execution_failed_source_message() -> str:
    return "Runtime tool execution failed."


def search_brief_not_ready_for_query_plan_source_message() -> str:
    return "Search Brief must be ready before validating a QueryPlan."
