...
AGENT_WORDING_USE_CASE_RECRUITER_CHAT_CONVERSATION = "recruiter_chat_conversation"
...
def agent_wording_system_prompt() -> str:
    return (
        ...
        "deterministic Agent Plan, Agent Response, onboarding, or safe recruiter-chat text "
